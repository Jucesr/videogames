#include "../Header Files/ScoreRecord.h"
...
ScoreRecord::ScoreRecord(){
    ...
    file = SDL_RWFromFile( "Resource Files\\scoreRecords.bin", "r+b" );

	if( file == NULL )
    {
		//Create file for writing
        file = SDL_RWFromFile( "Resource Files\\scoreRecords.bin", "w+b" );
	}else{
...
void ScoreRecord::addNewRecord(std::string name, int score){
