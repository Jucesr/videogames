...
/*
	...
	PLEASE READ. IMPORTANT IFORMATION.
	...
	One idea that I came up with and pretty ovbious I think is keeping thess key presses in a queue so no matter how fast or slow the
